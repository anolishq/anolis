...
software stop drives nothing — and whose latch then suppresses the hook you just added.
See [safety.md](safety.md#stop-categories--what-software-can-and-cannot-be).
